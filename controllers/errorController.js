...
const handleDuplicateErrorDB = (err) => {
  console.log(err);
  return new AppError(
    `The email "${err.keyValue.email}" is already been taken`,
    400
  );
};
...
const handleJWTError = () => new AppError(`Unauthenticated`, 401);

const handleJWTExpiredError = () => new AppError(`Unauthenticated`, 401);
